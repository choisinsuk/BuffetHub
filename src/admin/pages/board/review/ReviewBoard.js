...
import ReviewList from "./ReviewList"; // ReviewList 컴포넌트 가져오기
  ...
  return (
    <BoardLayout>
      <div className="text-5xl text-center">
        <div className="bg-customColor1 w-full px-3 py-20 rounded-lg flex items-center justify-center text-white text-bold">후기 게시판</div>
      </div>
      <BoardNav />
      <ReviewList posts={posts} /> {/* ReviewList에 posts 전달 */}
